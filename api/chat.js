export default async function handler(req, res) {
  try {
    ...
    const systemPrompt = `You are ${persona}, a supportive and knowledgeable guide. Respond to the user's message in a way that provides emotional support and guidance. Be empathetic, understanding, and non-judgmental.`;
